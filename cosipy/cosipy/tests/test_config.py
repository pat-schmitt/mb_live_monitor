...
import mb_live_monitor.cosipy.cosipy.config
...
class TestConfigParser:
    ...
    def test_set_parser(self):
        compare_parser = mb_live_monitor.cosipy.cosipy.config.set_parser()
    ...
    def test_user_arguments(self, arg_type):
        test_parser = mb_live_monitor.cosipy.cosipy.config.set_parser()
    ...
    def test_check_directory_exists(self):
        ...
        with pytest.raises(NotADirectoryError, match=error_message):
            mb_live_monitor.cosipy.cosipy.config.get_cosipy_path_from_env(name="COSIPY_DIR")
    ...
    def test_get_cosipy_path(
        ...
        test_name = arg_env[1]
        compare_path = mb_live_monitor.cosipy.cosipy.config.get_cosipy_path_from_env(name=test_name)
